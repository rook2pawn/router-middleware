...
handle.setCode = function(code) {
  handle[code] = setter(parseInt(code),routes,regexroutes,statusroutes)
}
handle.setMethod = function(method) {
  routes[method.toUpperCase()] = {}
  handle[method] = setter(method,routes,regexroutes,statusroutes)
}
handle.fileserver = function(_fileserver) {
  fileserver = _fileserver
}
handle.setstatusroutes = function(_statusroutes) {
  statusroutes = _statusroutes
}
